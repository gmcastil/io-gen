...
from tests.helpers import assert_list_equal_with_diff
...
# that directory:
#
#   pin_table.json  - The appropriate pin table data structure to test against
...
def test_xdc_cases(case: Path):
    ...
    # Load the pin table from the JSON file
    ...
    assert_list_equal_with_diff(expected, actual)
