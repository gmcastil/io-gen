...
def test_generate_verilog_ioring_file_header() -> None:
    """Output begins with the do-not-edit header comment."""
    st, pt = _make_tables(
        [{"name": "sys_clk", "pins": "G22", "direction": "in", "buffer": "ibuf", "iostandard": "LVCMOS18"}]
    )
    output = generate_verilog_ioring(st, pt, "test")
    lines = output.splitlines()
    assert lines[0] == "// Generated by io-gen - do not edit"
    assert lines[1] == "// Regenerate from source YAML using io-gen"
...
def test_generate_verilog_ioring_integration() -> None:
    ...
    lines = output.splitlines()
    assert lines[0] == "// Generated by io-gen - do not edit"
    assert lines[2] == "module example_io //#("
