...
VALID_BUFFER_STRATEGY_MATCH = [
    ...
    (
        "ibufds_pinset",
        {"name": "sig", "buffer": "ibufds", "pinset": {"p": "H22", "n": "H23"}},
    ),
    (
        "obufds_pinset",
        {"name": "sig", "buffer": "obufds", "pinset": {"p": "H22", "n": "H23"}},
    ),
    (
        "iobufds_pinset",
        {"name": "sig", "buffer": "iobufds", "pinset": {"p": "H22", "n": "H23"}},
    ),
...
INVALID_BUFFER_STRATEGY_MATCH = [
    (
        "ibuf_pinset",
        {"name": "sig", "buffer": "ibuf", "pinset": {"p": "H22", "n": "H23"}},
    ),
    (
        "obuf_pinset",
        {"name": "sig", "buffer": "obuf", "pinset": {"p": "H22", "n": "H23"}},
    ),
    (
        "iobuf_pinset",
        {"name": "sig", "buffer": "iobuf", "pinset": {"p": "H22", "n": "H23"}},
    ),
